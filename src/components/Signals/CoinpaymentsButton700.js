...
function CoinpaymentsButton700(userID) {
  return (
    <form action="https://www.coinpayments.net/index.php" method="post">
      ...
      {userID && (
        <input type="hidden" name="on1" defaultValue={userID.userID} />
      )}
      ...
      <input
        type="hidden"
        name="success_url"
        defaultValue="https://app.ohmiobroadcast.io/success-purchase-5month"
      />
      <input
        type="hidden"
        name="cancel_url"
      ...
      <input
        type="hidden"
        name="ipn_url"
        defaultValue="https://ipn.ohmiobroadcast.io/"
      />
...
export default CoinpaymentsButton700;

...
export default function PurchaseSuccessTrimestral() {
  // Chakra Color Mode
  ...
  async function updatePaymentStatus(ID) {
    ...
    let mm = today.getMonth() + 1 + 3; // Months start at 0! más un mes
      ...
      <Card style={styles.cardoffline}>
        ...
        >
          ...
          <Text align={"center"} fontWeight={300}>
            We are proccessing the payment and verifying, please check again in
            a moment or contact Support if have any trouble.
          </Text>
        </div>
      </Card>
    </Flex>
